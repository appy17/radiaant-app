...
function Footer() {
  return (
    <footer className="font-[sans-serif] bg-[#faf6f3] py-12 px-16  "  style={{backgroundImage: `url('/image/5936.jp'`}}>
  <div className="grid max-md-grid-cols-1 lg:grid-cols-2 gap-20">
    <div>
      <h4 className="text-black font-bold text-lg">About Us</h4>
      <p className="text-sm mt-6 text-[#828282]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean gravida,
      ...
      <ul className="grid max-sm:grid-cols-1 sm:grid-cols-2 mt-12 gap-2">
        <li className="flex items-center max-sm:mb-8">
          ...
          <a href="javascript:void(0)" className="text-[#828282] text-sm ml-3">
    ...
    <div>
      <h4 className="text-black font-bold text-lg">Newsletter</h4>
      <p className="text-sm mt-6 text-[#828282]">Subscribe to our newsletter and stay up to date with the latest news,
  ...
  <div className="lg:flex lg:item-center mt-12">
    <ul className="flex flex-wrap gap-4">
      <li>
        <a href='javascript:void(0)' className='text-[#828282] hover:text-black text-sm'>Terms of Service</a>
      </li>
      <li>
        <a href='javascript:void(0)' className='text-[#828282] hover:text-black text-sm'>Privacy Policy</a>
      </li>
      <li>
        <a href='javascript:void(0)' className='text-[#828282] hover:text-black text-sm'>Security</a>
      </li>
    </ul>
    <p className='text-sm text-[#828282] lg:ml-auto max-lg:mt-6 flex justify-center'>Copyright © 2024<a href='https://www.royalswebtech.com/'
