...
function Contactus() {
  return (
    <>
      <div className="grid md:grid-cols-2 gap-16 items-center  p-10 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white text-[#333] my-6 font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-[#faf6f3]  max-md:before:hidden">
        <div className="">
          ...
          <ul className="mt-4 flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
            <li
              className="flex items-center hover:text-[#828282]
            ...
            <li className="flex items-center text-current hover:text-[#828282]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16px"
                height="16px"
